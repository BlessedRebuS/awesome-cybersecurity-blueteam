...
- [Krawl](https://github.com/BlessedRebuS/Krawl) - A customizable web honeypot and deception server for detecting malicious attackers, crawlers, and automated scanners.
